    ...
    <AuthLayout quote="The crowd was loud. The memory is louder." credit="TicketBox Selects · Hanoi">
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={submit}>
          <label className="field"><span>Full name</span><input name="fullName" autoComplete="name" placeholder="Minh Quân…" required /></label>
          <div className="form-grid form-grid-two">
            ...
            <label className="field"><span>Phone number</span><input type="tel" name="phone" autoComplete="tel" placeholder="+84 901 234 567…" required /></label>
          </div>
          <div className="form-grid form-grid-two">
