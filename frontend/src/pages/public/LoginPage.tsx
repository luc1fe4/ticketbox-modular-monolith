          ...
          <form className="space-y-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-bg py-3.5 pl-12 pr-4 text-on-surface placeholder:text-outline outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-bg py-3.5 pl-12 pr-12 text-on-surface placeholder:text-outline outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
              />
              <button
                type="button"
